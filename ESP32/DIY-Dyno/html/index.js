...
function onLoad(event) {
    ...
    // For DIY Dyno, we show all load and performance tiles
    ...
    // Hide unused legacy-only tiles
    if (document.getElementById('maf-tile')) document.getElementById('maf-tile').style.display='none';
    if (document.getElementById('tile-pitot')) document.getElementById('tile-pitot').style.display='none';
    if (document.getElementById('tile-fdiff')) document.getElementById('tile-fdiff').style.display='none';
