...
struct BenchSettings {
  ...
  int tatltuae = 42;
  int parsecs = 12;
  String pageTitle = "DIY Dyno";                  // Display name for software
  ...
  String hostname = "diydyno";                    // Default Hostname
...
struct SensorData {
  ...
  double LoadForceKG = 0.0;
  double FlowCFMraw = 0.0;
  double FlowCFMunc = 0.0;
  double PowerHP = 0.0;
  double PowerHPCorrected = 0.0;
  double TorqueCorrectedNM = 0.0;
...
struct Pins {
  ...
  int VCC_3V3 = -1;
  int SPEED_SENS = -1;
  int LF_BCD_1 = -1; // unused legacy
  int LF_BCD_2 = -1; // unused legacy
  int LF_BCD_3 = -1; // unused legacy
  int LC_DOUT = -1;
  int LC_SCK = -1;
  int PDIFF = -1;
  int PITOT = -1;
...
struct Language {
    ...
    char LANG_GUI_SELECT_LIFT_VAL_BEFORE_CAPTURE[50] = "Select capture index before capture";
    char LANG_GUI_LIFT_VAL[50] = "Capture Point";
    ...
    char LANG_GUI_USER_FLOW_TARGET_VAL[50] = "User Torque Target Value";
    char LANG_GUI_SAVE[50] = "Save";
    char LANG_GUI_CALIBRATE[50] = "Calibrate";
    char LANG_GUI_CAL_FLOW_OFFSET[50] = "Calibrate Load Cell Tare";
    char LANG_GUI_CAL_LEAK_TEST[50] = "not used";
    char LANG_GUI_LOAD_LIFT_PROFILE[50] = "Load Dyno Run Data";
    char LANG_GUI_LOAD_LIFT_PROFILE_LOAD[50] = "Load";
    char LANG_GUI_SAVE_LIFT_DATA[50] = "Save Dyno Run Data";
    ...
    char LANG_GUI_PREF[50] = "Load (kg)";  
    char LANG_GUI_PDIFF[50] = "Torque (Nm)";
    char LANG_GUI_FLOW[50] = "Horsepower (HP)";
    char LANG_GUI_AFLOW[50] = "Corrected Torque (Nm)";
    char LANG_GUI_SFLOW[50] = "Corrected Horsepower (HP)";
    char LANG_GUI_MFLOW[50] = "Load cell RAW";
    char LANG_GUI_SWIRL[50] = "Engine Speed (RPM)";
    char LANG_GUI_FLOW_DIFF[50] = "Torque Diff";
    char LANG_GUI_TEMP[50] = "Temperature";
    char LANG_GUI_BARO[50] = "Baro Pressure";
    char LANG_GUI_HUMIDITY[50] = "Humidity";
    char LANG_GUI_START[50] = "Start Dyno";
    char LANG_GUI_STOP[50] = "Stop Dyno";
    ...
    char LANG_GUI_GENERAL_SETTINGS[50] = "Dyno Settings";
    char LANG_GUI_MAF_DIAMETER[50] = "Torque Arm (mm)";
    char LANG_GUI_REFRESH_RATE[50] = "GUI Refresh Rate (ms)";
    char LANG_GUI_TEMPERATURE_UNIT[50] = "Temp Unit (&degC / &degF)";
    char LANG_GUI_LIFT_INTERVAL[50] = "Default RPM Step";
    char LANG_GUI_DATA_GRAPH_MAX_VAL[50] = "Max Scale Value";
    char LANG_GUI_RESOLUTION_AND_ACCURACY[50] = "Resolution and Accuracy";
    char LANG_GUI_FLOW_VAL_ROUNDING[50] = "HP Rounding Type";
    char LANG_GUI_FLOW_DECIMAL_ACCURACY[50] = "HP Accuracy";
